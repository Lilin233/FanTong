...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-FanTong/SDWebImage.framework"
  install_framework "Pods-FanTong/TDOAuth.framework"
  install_framework "Pods-FanTong/YYModel.framework"
  install_framework "Pods-FanTong/YYText.framework"
fi
